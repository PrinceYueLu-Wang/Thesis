...
class darias_OSC:
    ...
    def loadModel(self):
        ...
        self.modelPath=os.path.join(self.scriptDir,"model/darias.urdf")
        ...
        self.armJointIdx_right=[1,2,3,4,5,6,7]
        self.armJointIdx_left=[23,24,25,26,27,28,29]
    ...
    def initPybullt(self):
        ...
        p.loadURDF('sphere_10cm.urdf', np.array([0.8, 0., 0.8]), # TODO: Put an object in target postion
