...
class DariasHandSimple():
    ...
    def __init__(self, reward_type=0, time_step=1 / 240.):
        ...
        self.table_file = os.path.join(basename, "robots/table/table.urdf")
        self.cylinder_file = os.path.join(basename, 'robots/geo/cylinder.urdf')
        ...
        self.tableId = p.loadURDF(self.table_file, [0.4, 0, 0], p.getQuaternionFromEuler([0., 0., -1.5707963]))

        self.cylinderId = p.loadURDF(self.cylinder_file, [0.4, 0., 0.8], p.getQuaternionFromEuler([0., 0., 0.]))
