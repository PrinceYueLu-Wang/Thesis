...
from prmp.envs import DariasHandSimple
from prmp.cep_models import cep_simple_model
import torch
...
class CEPPolicy():
    def __init__(self, env, dt=1 / 240., dtype='float64', q_home = None):
        self.dt = dt
        self.dtype = dtype
...
def experiment():
    ...
    robot_urdf = env.robot_file
    q_home = env.q_home

    policy = CEPPolicy(env=env, dt=time_step, q_home=q_home)
    ################
