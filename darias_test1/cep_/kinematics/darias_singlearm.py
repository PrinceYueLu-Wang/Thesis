...
class DarIASArm_single(Robot):
    def __init__(self):
        super(DarIASArm_single, self).__init__(urdf_file=urdf_filename, link_name_list=link_names)


if __name__ == '__main__':
    dar_kin = DarIASArm_single()
    a=dar_kin.links_JInv()
    print(a)
